...
const (
	DiscriminatorEmployee pubsub.Discriminator = "HR_Employee"
	DiscriminatorPosition pubsub.Discriminator = "HR_Position"
	DiscriminatorRole     pubsub.Discriminator = "HR_Role"
)
